    ...
    **kwargs,
    ...
    for epoch in range(num_epoch):
        ...
        for img, label in train_data:
            ...
            logger.add_scalar("train/acc", batch_acc, global_step)
        ...
        epoch_loss = torch.as_tensor(epoch_train_loss).mean()

        logger.add_scalar("epoch/train_acc", epoch_train_acc.item(), epoch)
        logger.add_scalar("epoch/val_acc", epoch_val_acc.item(), epoch)
        logger.add_scalar("epoch/train_loss", epoch_loss.item(), epoch)
